...
public class CategoryController {
	 ...
	 * category 2. 409(CONFLICT) - In case of duplicate categoryId
	 *
	 * 
	 ...
	 * 
	 * This handler method should map to the URL "/api/v1/category/{id}" using
	 * HTTP Delete method" where "id" should be replaced by a valid categoryId
	 * without {}
	 */
	 ...
	 * details in database. This handler method should return any one of the
	 * status messages basis on different situations: 1. 200(OK) - If the
	 * category updated successfully. 2. 404(NOT FOUND) - If the category with
	 * specified categoryId is not found. This handler method should map to the
	 * URL "/api/v1/category/{id}" using HTTP PUT method.
	 */
